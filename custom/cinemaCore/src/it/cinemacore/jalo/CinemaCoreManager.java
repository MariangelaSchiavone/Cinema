...
/**
 * This is the extension manager of the CinemaCore extension.
 */
public class CinemaCoreManager extends GeneratedCinemaCoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CinemaCoreManager.class.getName());
	 ...
	 */
	public static CinemaCoreManager getInstance()
	{
		return (CinemaCoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CinemaCoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CinemaCoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CinemaCoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CinemaCoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CinemaCoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
