...
import it.cinemafacade.constants.CinemaFacadeConstants;



/**
 * This is the extension manager of the CinemaFacade extension.
 */
public class CinemaFacadeManager extends GeneratedCinemaFacadeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CinemaFacadeManager.class.getName());
	 ...
	 */
	public static CinemaFacadeManager getInstance()
	{
		return (CinemaFacadeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CinemaFacadeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CinemaFacadeManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CinemaFacadeManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CinemaFacadeManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CinemaFacadeManager called, current tenant: " + getTenant().getTenantID());
		}
	}
