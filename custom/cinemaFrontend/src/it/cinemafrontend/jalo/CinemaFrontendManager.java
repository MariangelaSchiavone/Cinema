...
/**
 * This is the extension manager of the CinemaFrontend extension.
 */
public class CinemaFrontendManager extends GeneratedCinemaFrontendManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CinemaFrontendManager.class.getName());
	 ...
	 */
	public static CinemaFrontendManager getInstance()
	{
		return (CinemaFrontendManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CinemaFrontendConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CinemaFrontendManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CinemaFrontendManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CinemaFrontendManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CinemaFrontendManager called, current tenant: " + getTenant().getTenantID());
		}
	}
